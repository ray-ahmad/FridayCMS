...
?>
		...
		<section class="content">
			<form action="" method="post" enctype="multipart/form-data" id="form-edit">
						...
						<div class="box box-primary">
							...
							<div class="box-body">
								<div class="form-group">
									<label>Judul *</label>
									<input type="text" title="Judul" name="title" id="title" class="form-control" placeholder="Judul post mu disini..." value="<?php echo set_value("title") ?>" required>
								</div>
								<?php
									$ex = BASE_URL . "post/";
								?>
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" name="sefurl" id="sefurl" class="form-control" placeholder="SEF URL untuk post mu disini..." value="<?php echo set_value("sefurl") ?>">
									</div>
								...
								<div class="form-group">
									<label>Konten *</label>
									<textarea class="form-control" id="<?php echo $tinymce_id ?>" name="content" placeholder="Isi post mu disini..." style="height: 350px;" required><?php echo set_value("content") ?></textarea>
								</div>
							</div><!-- /.box-body -->
						</div><!-- /.box -->
					</div>
								...
								<div id="collapseThree" class="panel-collapse collapse">
									<div class="box-body">
										<div class="form-group">
											...
											<input type="text" name="keywords" class="form-control" placeholder="Keywords post mu disini..." value="<?php echo set_value("keywords") ?>">
										</div>	
										<div class="form-group">
											<label>Meta Description</label>
											<textarea name="description" class="form-control" placeholder="Deskripsi post mu disini..." style="height: 100px;"><?php echo set_value("description") ?></textarea>
				...
				<div class="form-group">
					<button type="submit" name="submit" class="btn-edit-sub btn btn-primary btn-flat" <?php if($categories_data == 0) echo("disabled"); ?>>Buat Post!</button>
