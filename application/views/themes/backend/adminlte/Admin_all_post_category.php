...
?>
        ...
        <section class="content-header">
          <h1>
            <?php echo $this->lang->line("all_post_categories") ?>
            <small>FridayCMS</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?php echo admin_url() ?>"><i class="fa fa-dashboard"></i> <?php echo $this->lang->line("homepage") ?></a></li>
            <li class="active"><a href="<?php echo $this->to_cat ?>"><i class="fa fa-tasks"></i> <?php echo $this->lang->line("all_post_categories") ?></a></li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box box-success">
            ...
            <div class="box-body with-border">			
				<div class="btn-group">
					<?php if ($this->user->check_privilege($this->user_id, "write", "post_category")) : ?><a class="btn btn-success btn-flat margin" href="<?php echo $this->to_cat ?>create/"><i class="fa fa-edit"></i> <?php echo $this->lang->line("create_new_post_category") ?>!</a><?php endif ?>
					<?php if ($this->user->check_privilege($this->user_id, "delete_all", "post_category")) : ?><button class="btn btn-danger btn-flat margin" type="button" data-toggle="modal" data-target="#alertalldel"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line("delete_all_post_categories") ?>!</button><?php endif ?>
				</div>
            </div><!-- /.box-body -->
			
			<div class="box-body table-responsive">
				<?php if ($this->user->check_privilege($this->user_id, "delete_selected", "post_category")) : ?><form action="<?php echo $this->to_cat ?>delete/selected/" method="post"><?php endif ?>
				  <table id="<?php echo $datatables_id ?>" class="table table-bordered row-border table-striped">
					<thead>
						<tr>
							<th class="no-sort"><i class="fa fa-check-circle-o"></i></th>
							<th><?php echo $this->lang->line("post_category_id") ?></th>
				...
				<?php if ($this->user->check_privilege($this->user_id, "delete_selected", "post_category")) : ?>  
				  <button class="btn btn-danger btn-flat" type="button" data-toggle="modal" data-target="#alertdelselect"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line("delete_selected_post_categories") ?></button>
					...
					<div class="modal-dialog">
						<div class="modal-content">
								<div class="modal-header">
									...
									<h3 id="modal-title"><i class="fa fa-exclamation-triangle"></i> <?php echo $this->lang->line("post_category_alert_delete_1_header") ?></h3>
								</div>
								<div class="modal-body">
									<?php echo $this->lang->line("post_category_alert_delete_1_body") ?>
								</div>
			...
			<?php if ($this->user->check_privilege($this->user_id, "delete", "post_category")) : ?>
			<form action="<?php echo $this->to_cat ?>delete/" method="post">
				<div id="modal_del" class="modal modal-danger fade" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
								<h3 id="modal-title"><i class="fa fa-exclamation-triangle"></i> <?php echo $this->lang->line("post_category_alert_delete_2_header") ?></h3>
							</div>
							<div class="modal-body">
								<?php echo $this->lang->line("post_category_alert_delete_2_body") ?>
							</div>
							<div class="modal-footer">
			...
			<?php
				...
				if ($this->user->check_privilege($this->user_id, "delete_all", "post_category")) :
			?>
					...
					<div class="modal-dialog">
						<div class="modal-content">
								<div class="modal-header">
									...
									<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
									<h3 id="modal-title"><i class="fa fa-exclamation-triangle"></i> <?php echo $this->lang->line("post_category_alert_delete_3_header") ?></h3>
								</div>
								<div class="modal-body">
									<?php echo $this->lang->line("post_category_alert_delete_3_body") ?>
								</div>
								<div class="modal-footer">
									<form action="<?php echo $this->to_cat ?>delete/all/" method="post">
										<button type="button" class="btn btn-default btn-flat" data-dismiss="modal" aria-hidden="true"><i class="fa fa-sign-out"></i> <?php echo $this->lang->line("confirm_no") ?></button>
										<button type="submit" class="btn btn-outline btn-flat" onClick="return confirm('<?php echo $this->lang->line("post_category_alert_delete_4_body") ?>')"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line("confirm_yes") ?></button>
									</form>
								</div>
						</div>
					</div>
