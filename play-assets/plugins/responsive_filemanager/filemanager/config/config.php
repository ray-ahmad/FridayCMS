<?php
	if (file_exists("../../../../play-config/config.php"))
		require_once "../../../../play-config/config.php";
/*
|--------------------------------------------------------------------------
| Optional security
|--------------------------------------------------------------------------
...
define('USE_ACCESS_KEYS', USE_ACCESS_KEY_FILEMANAGER); // TRUE or FALSE
/*
|--------------------------------------------------------------------------
...
$config = array(
	...
	*/
	...
	|
	*/
	'thumbs_base_path' => IMG_THUMBS_PATH_FILEMANAGER,
	...
	*/
	...
	'access_keys' => $access_key_filemanager,
	...
	*/
	...
	|
	*/
	'MaxSizeUpload' => MAX_SIZE_FILEMANAGER,
