...
//edited by playcms (add isset() func)
if (isset($_SESSION['RF']["verify"]) and $_SESSION['RF']["verify"] != "RESPONSIVEfilemanager")
{
...
/*
  --------------------------------------------------------------------
  Saya komentar aja baris ini, gagal upload terus soalnya kalau 
  direktorinya di assets/file/. Setelah saya komentar baris ini, 
  ternyata normal-normal aja kok uploadnya....
  --------------------------------------------------------------------
